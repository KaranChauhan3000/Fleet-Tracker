...
const companySettingsCtrl = require('../controllers/companySettingsController');
...
// ── Company Settings ──────────────────────────────────────────────────────────
router.get('/company-settings', companySettingsCtrl.getCompanySettings);
router.put('/company-settings', companySettingsCtrl.updateCompanySettings);

// ── Dashboard ─────────────────────────────────────────────────────
router.get('/stats', dashboardCtrl.getStats);
router.get('/stats/monthly-vehicle-breakdown', dashboardCtrl.getMonthlyVehicleBreakdown);
...
// ── Location timeline (admin view) ───────────────────────────────────────────
const locCtrl = require('../controllers/locationController');
router.get('/users/:id/location-timeline', locCtrl.getTimeline);
...
router.get('/fuel-logs/status-summary', fuelLogCtrl.getFuelLogStatusSummary); // must be before /:id
...
router.patch('/fuel-logs/:id/status',
  upload.single('proofImage'),
  fuelLogCtrl.updateFuelLogStatus
);
