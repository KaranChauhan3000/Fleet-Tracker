...
exports.getExpenseBreakdown = async (req, res, next) => {
  try {
    ...
    const [fuelByVehicle, challanByVehicle, serviceByVehicle, vehicles, fuelDailyTrend, challanList, serviceList] = await Promise.all([
    ...
    for (const vid of vehicleSet) {
      ...
      const total   = fuel.totalCost + challan.totalAmount + service.totalCost;
    ...
    const grandTotal    = totalFuel + totalChallan + totalService;
