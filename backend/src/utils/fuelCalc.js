 ...
 *
 *   Log 2 onwards: cumulative average from the very first fill
 *     kmDriven  = current odometer − previous odometer  (segment distance)
 *     efficiency = (current odometer − first odometer) ÷ (sum of ALL previous fills)
 *
 * Example: 10L@1000km, 10L@1500km, 10L@2000km, 10L@2500km
 *   Log2: kmDriven=500, efficiency = 500km  / 10L = 50.0 km/L
 *   Log3: kmDriven=500, efficiency = 1000km / 20L = 50.0 km/L
 *   Log4: kmDriven=500, efficiency = 1500km / 30L = 50.0 km/L
 *
 * The CURRENT fill is skipped because that fuel is still in the tank —
 * only litres that were actually consumed to drive those kilometres count.
 *
